...
def generate_edge_clauses(e, k):
    ...
    for color in range(1, k+1):
        ...
        clause = []
        clause = clause + [-1*node2var(e[0], color, k)]
        clause = clause + [-1*node2var(e[1], color, k)]
        clause_ls = clause_ls + [clause]
    return clause_ls
...
#    graph_coloring_to_sat("graph2.txt", "graph2_6colors.txt", 6)

#    graph_coloring_to_sat("graph2.txt", "graph2_7colors.txt", 7)

#    graph_coloring_to_sat("graph2.txt", "graph2_8colors.txt", 8)

#    graph_coloring_to_sat("graph2.txt", "graph2_9colors.txt", 9)
